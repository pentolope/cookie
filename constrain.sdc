...
create_generated_clock -name {ip_pll_internal_inst|altpll_component|auto_generated|pll1|clk[0]} -source [get_pins {ip_pll_internal_inst|altpll_component|auto_generated|pll1|inclk[0]}] -duty_cycle 50/1 -multiply_by 9 -divide_by 5 -master_clock {MAX10_CLK1_50} [get_pins {ip_pll_internal_inst|altpll_component|auto_generated|pll1|clk[0]}] 
...
create_generated_clock -name {ip_pll_vga_inst|altpll_component|auto_generated|pll1|clk[0]} -source [get_pins {ip_pll_vga_inst|altpll_component|auto_generated|pll1|inclk[0]}] -duty_cycle 50/1 -multiply_by 71 -divide_by 282 -master_clock {MAX10_CLK1_50} [get_pins {ip_pll_vga_inst|altpll_component|auto_generated|pll1|clk[0]}] 
